 ...
 <div class="row">
		<div class="col-md-12">
			<ul class="nav nav-pills">
				...
				<li class="active">
					<a id="paral" href="#">Booked Flights</a>
				</li>
				<li>
...
<div class="row" >
       <div class="col-md-12" style="position:absolute; left:0px; top:300px;" >
           ...
           <form class="form" id="searchSubmit"  style="background: rgba(0,0,0,0.2); margin-bottom: 40px; margin-top: 40px;">
               ...
               <datalist id="flightId" style="margin-top:40px;">
                                       <!--  <option value="UA-301">
                                            <option value="9W-415">
                                            <option value="9W-416">
                                            <option value="9W-417">    
               ...
               <div class="form-group">
                   <label for="time" style="color:white; margin-left:720px;">Flight Timings Between</label>
                   <input id="time" type="datetime-local" name="time" class="form-control" style="width:20%; margin-left:650px; " > 
               </div>
               <div class="form-group">    
               <input id="time1" type="datetime-local" name="time1" class="form-control" style="width:20%; margin-left:650px;" > 
